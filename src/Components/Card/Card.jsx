...
const Card = ({ title, price, image, image2, imageDetail, dia, fecha, hora, lugar, description }) => {
  ...
  return (
    ...
    >
      ...
      <Link to={`/CardDetail`}  state={{ image, image2, imageDetail, title, price, dia, fecha, hora, lugar, description }}  className='buy-button'>Comprar Entrada</Link>
