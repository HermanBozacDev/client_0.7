...
export const GuiaDeCompra = () => {
  ...
  return (
    <div className='guiaDeCompraContainer'>
      ...
      <h2 className='tituloInformacionGuia'>Guía de Compra - Medios de Pago - Preguntas Frecuentes</h2>
      <h3 className='tituloInformacionAdministrativa'>Guia de compra</h3>
      ...
      <h3 className='tituloInformacionAdministrativa'>Métodos de Pago</h3>

      <p className='desarrollo'>Trabajamos conectando con la plataforma de Mercado-Pago.</p>

      <h3 className='tituloInformacionAdministrativa'>Preguntas Frecuentes</h3>
